...
def main(argv):
	...
	if orgid == 'null':
	# Verificacion de la API correcta
	...
	for nwrecord in nwlist:
		...
		for i in range (0, len(devicelist)):
			...
			#Despliegue the codigo serial y el modelo del equipo


			recordstring = orgid + ',' + devicelist[i]['serial'] + ',' + devicelist[i]['model']
			print(type(orgid))
			try:
...
if __name__ == '__main__':
  main(['-k','c18d6557eecebd80c8e38188e3a64cd64b4f56e7', '-o', 'Devnet-GroupSigma'])
